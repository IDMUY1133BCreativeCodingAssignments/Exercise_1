int monX, monY;
int skin1 = color(24, 200, 167);
int skin2 = color(200,35,69);
void setup(){
size(1000, 1000); //Box Monster Sketch
background(255);
}
void draw(){
 
monsterBase(0, 0,skin2);
monsterBase(200,200,skin1);

}

void monsterBase(int mX, int mY, int sk1){

  fill(sk1);
stroke(0);strokeWeight(2);
triangle(400+mX ,200+mY, 285+mX, 400+mY, 515+mX, 400+mY); //Bill Cipher Body
stroke(238,215,47);
noFill();
